...
namespace clipr
{
    ...
    public class CliParser<T> where T : class
    {
        ...
        /// </param>
        public CliParser(T obj, IHelpGenerator<T> usageGenerator)
        ...
        /// Generates help documentation for this parser.
        /// </param>
        public CliParser(T obj, ParserOptions options, IHelpGenerator<T> usageGenerator)
        {
            if (obj == null)
            {
        ...
        {
            var usageGenerator = new AutomaticHelpGenerator<T>();
            try
            {
                Parse(args);
                return;
